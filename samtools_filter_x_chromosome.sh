...
# this was originally /gpfs/data/bergstrom/paula/fox_repo/no_longer_used/data/marked_duplicates
	...
	#Submit a Slurm job using --wrap
 	sbatch --job-name="filter_x_${base_name}" \
        	...
        	--mem=16G \
         	...
         	--wrap="samtools view -h -b -r chrX $bam_file -o $output_file"
break 
done

# java -jar /gpfs/software/ada/samtools/1.21/ view -h -b -r chrX $bam_file -o $output_file
